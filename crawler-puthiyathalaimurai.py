...
LINKS         = [HTTP + ROOT_URL, ]
LINKS         = ['http://www.puthiyathalaimurai.com/videos/infotainment-programmes/puthu-puthu-arthangal', 'http://www.puthiyathalaimurai.com/news/tamilnadu/56396-a-woman-affected-hiv-due-to-falls-blood-transfer-in-govt-hospital-at-salem.html?utm_source=site&utm_medium=home_banner&utm_campaign=home_banner']
VISITED_LINKS = set()
