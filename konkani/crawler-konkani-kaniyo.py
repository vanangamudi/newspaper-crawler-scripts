# For now, just began editing crawler-oneindia.py
...
class KonkaniKaniyoCrawler(MultiThreadedCrawler2):
...
if __name__ == '__main__':
    crawler = KonkaniKaniyoCrawler('konkani-kaniyo-in-nagri.blogspot.com', num_threads=12)
